function [facts,D,err,L,coord_choices,idx_freq] = givens_ptj(Lap,J,t)
% This function is modified from diagonalization_givens_parall, with the
% following changes
% 1. it does not sort the spectrum
% 2. it outputs an additional argument, indicating the order of GFT
