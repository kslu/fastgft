function [facts,D,err,L,coord_choices,idx_freq] = givens_tj(Lap,J)
% This function is modified from diagonalization_givens, with the following
% changes:
% 1. it outputs an additional argument, indicating the order of GFT
